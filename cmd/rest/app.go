...
import (
	...
	_ "github.com/lib/pq"
	"github.com/soerjadi/apollo/internal/config"
	"github.com/soerjadi/apollo/internal/delivery/rest"
	userDelivery "github.com/soerjadi/apollo/internal/delivery/rest/user"
	"github.com/soerjadi/apollo/internal/pkg/log"
	"github.com/soerjadi/apollo/internal/repository/user"
	userUsecase "github.com/soerjadi/apollo/internal/usecase/user"
)
...
func initiateHandler(cfg *config.Config, db *sqlx.DB) ([]rest.API, error) {
	...
	handler := userDelivery.NewHandler(userUsecase)
